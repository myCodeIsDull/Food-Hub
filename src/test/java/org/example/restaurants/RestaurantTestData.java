...
public class RestaurantTestData {
    ...
    public static final TestMatcher<Restaurant> RESTAURANT_MATCHER = TestMatcher.usingFieldsComparator("address");
    ...
    public static final Restaurant CROWN_FRIED_CHICKEN = new Restaurant(CFC_ID, "Crown Fried Chicken", parseLocalDate("2018-12-03"), CFC_ADDRESS);

    public static final Restaurant MC_DONALDS = new Restaurant(MCD_ID, "McDonalds", parseLocalDate("2017-08-11"), McD_ADDRESS);

    public static final Restaurant VENICE = new Restaurant(VENICE_ID, "Venice", parseLocalDate("2020-03-25"), VENICE_ADDRESS);

    public static final Restaurant VEGAN = new Restaurant(VEG_ID, "Tap And Tandoor", parseLocalDate("2020-05-09"), VEG_ADDRESS);

    public static final Restaurant SEAFOOD_HEAVEN = new Restaurant(SFH_ID, "Seafood Heaven", parseLocalDate("2019-04-08"), SFH_ADDRESS);

    public static final Restaurant UPDATED = new Restaurant(CFC_ID, "Updated", parseLocalDate("2018-12-03"), false, CFC_ADDRESS);

    public static final Restaurant NOT_FOUND = new Restaurant(NOT_FOUND_ID, "", LocalDate.now(), NEW_ADDRESS);
